...
//  Dedi
//
//  Created by btider-salih on 06/08/2018.
...
/**
 ...
 ````
 */
@objcMembers class ShareLocationManager: NSObject, CLLocationManagerDelegate {
    ...
    */
    private func showNoImageError() {
        ...
        let message = NSLocalizedString("FAILED_GET_STATIC_MAP_BODY", comment: "Dedi needs an internet connection to send your current location")
    ...
    */
    private func showNoLocationError() {
        ...
        let message = NSLocalizedString("FAILED_GET_LOCATION_BODY", comment: "Dedi could not determine your current location.")
        let okButton = NSLocalizedString("OK", comment:"")
